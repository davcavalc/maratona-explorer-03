			...
			<section className="border-box border-4 border-orange-900 mt-3 mx-72">
				<div className="mx-3 my-3">
					<div className="flex justify-between font-bold uppercase">
						<h2 className="italic text-black">suco de alface</h2>
						<span className="text-black">R$ 37,70</span>
					</div>
					<details className="mt-3 bg-orange-200 mx-3">
						<summary className="font-bold text-black">Descrição</summary>
				...
				<div className="mx-3 my-3">
					<div className="flex justify-between font-bold uppercase">
						<h2 className="italic text-black">vinho fino</h2>
						<span className="text-black">R$ 37,70</span>
					</div>
					<details className="mt-3 bg-orange-200 mx-3">
						<summary className="font-bold text-black">Descrição</summary>
				...
				<div className="mx-3 my-3">
					<div className="flex justify-between font-bold uppercase">
						<h2 className="italic text-black">suco de maçã</h2>
						<span className="text-black">R$ 37,70</span>
					</div>
					<details className="mt-3 bg-orange-200 mx-3">
						<summary className="font-bold text-black">Descrição</summary>
